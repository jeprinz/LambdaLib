...
Lemma congr_fst {s0 : tm} {t0 : tm} (H0 : s0 = t0) : fst s0 = fst t0.
Proof.
exact (eq_trans eq_refl (ap (fun x => fst x) H0)).
Qed.

Lemma congr_snd {s0 : tm} {t0 : tm} (H0 : s0 = t0) : snd s0 = snd t0.
Proof.
exact (eq_trans eq_refl (ap (fun x => snd x) H0)).
Qed.
...
subst_tm sigma_tm s = s :=
  ...
  | fst s0 => congr_fst (idSubst_tm sigma_tm Eq_tm s0)
  | snd s0 => congr_snd (idSubst_tm sigma_tm Eq_tm s0)
  end.
...
ren_tm xi_tm s = ren_tm zeta_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (extRen_tm xi_tm zeta_tm Eq_tm s0)
        (extRen_tm xi_tm zeta_tm Eq_tm s1)
  | fst s0 => congr_fst (extRen_tm xi_tm zeta_tm Eq_tm s0)
  | snd s0 => congr_snd (extRen_tm xi_tm zeta_tm Eq_tm s0)
  end.
...
subst_tm sigma_tm s = subst_tm tau_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (ext_tm sigma_tm tau_tm Eq_tm s0)
        (ext_tm sigma_tm tau_tm Eq_tm s1)
  | fst s0 => congr_fst (ext_tm sigma_tm tau_tm Eq_tm s0)
  | snd s0 => congr_snd (ext_tm sigma_tm tau_tm Eq_tm s0)
  end.
...
(s : tm) {struct s} : ren_tm zeta_tm (ren_tm xi_tm s) = ren_tm rho_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
        (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s1)
  | fst s0 => congr_fst (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
  | snd s0 => congr_snd (compRenRen_tm xi_tm zeta_tm rho_tm Eq_tm s0)
  end.
...
subst_tm tau_tm (ren_tm xi_tm s) = subst_tm theta_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
        (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s1)
  | fst s0 => congr_fst (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
  | snd s0 => congr_snd (compRenSubst_tm xi_tm tau_tm theta_tm Eq_tm s0)
  end.
...
ren_tm zeta_tm (subst_tm sigma_tm s) = subst_tm theta_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
        (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s1)
  | fst s0 => congr_fst (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
  | snd s0 => congr_snd (compSubstRen_tm sigma_tm zeta_tm theta_tm Eq_tm s0)
  end.
...
subst_tm tau_tm (subst_tm sigma_tm s) = subst_tm theta_tm s :=
  ...
  | pair s0 s1 =>
      congr_pair (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
        (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s1)
  | fst s0 => congr_fst (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
  | snd s0 => congr_snd (compSubstSubst_tm sigma_tm tau_tm theta_tm Eq_tm s0)
  end.
...
(Eq_tm : forall x, funcomp (var_tm) xi_tm x = sigma_tm x) (s : tm) {struct s}
  ...
  | pair s0 s1 =>
      congr_pair (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
        (rinst_inst_tm xi_tm sigma_tm Eq_tm s1)
  | fst s0 => congr_fst (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
  | snd s0 => congr_snd (rinst_inst_tm xi_tm sigma_tm Eq_tm s0)
  end.
